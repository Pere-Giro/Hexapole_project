function [ O ] = kinematiceq2( ls,p,rpy,A )
%KINEMATICEQ1 Summary of this function goes here units of meters [m]
...
%O is the value of the equation (F(x)=0; O=ls^2-(norm(p+R*bi-ai))^2) [MAIN OBJECTIVE
%OF THIS FUNCTION]

%rotation matrix, angles must be introduced in rad; rpy==radians
...
%in ABS ref. (matrix of platform position in ABS ref.) [WRNING] units are
%in meters [m]
